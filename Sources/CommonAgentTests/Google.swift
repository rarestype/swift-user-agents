...
@Suite struct Google {
    ...
    @Test static func Googlebot2() throws {
    ...
    @Test static func Googlebot3() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
    ...
    @Test static func GooglebotMobile() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
    ...
    @Test static func Storebot() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
    ...
    @Test static func StorebotMobile() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
                Mozilla/5.0 \
    ...
    @Test static func InspectionTool() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
    ...
    @Test static func InspectionToolMobile() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
                Mozilla/5.0 (Linux; Android 6.0.1; Nexus 5X Build/MMB29P) \
                AppleWebKit/537.36 (KHTML, like Gecko) \
                Chrome/132.0.6834.83 Mobile Safari/537.36 \
    ...
    @Test static func GoogleOther() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
                Mozilla/5.0 AppleWebKit/537.36 \
    ...
    @Test static func GoogleOtherMobile() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
                Mozilla/5.0 (Linux; Android 6.0.1; Nexus 5X Build/MMB29P) \
                AppleWebKit/537.36 (KHTML, like Gecko) \
                Chrome/132.0.6834.83 Mobile Safari/537.36 \
    ...
    @Test static func GoogleOtherImage() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
    ...
    @Test static func GoogleOtherVideo() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
    ...
    @Test static func GoogleCloudVertexBot() throws {
        let crawler: UA.Google = try #require(.init(detecting: """
