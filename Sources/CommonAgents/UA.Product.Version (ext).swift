...
extension UA.Product.Version {
    public var quadruple: (Int, Int, Int, Int)? {
        ...
        let xc: Int = .init(string[i ..< x]) else {
            return nil
        }
        ...
        let yc: Int = .init(string[i ..< y]) else {
            return nil
        }
